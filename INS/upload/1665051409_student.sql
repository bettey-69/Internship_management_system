...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3223515984ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=student&table=stud_record">`student`.`stud_record`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=student&table=user_manage">`student`.`user_manage`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=user&table=user_manage">`user`.`user_manage`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6b68772f564b635351696e523a3d5d36">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="student" targettable="stud_record">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `stud_record`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="user_manage">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_manage`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="student" targettable="stud_record">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_manage`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="student" targettable="user_manage">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
